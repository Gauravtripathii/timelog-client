  ...
  return (
    <div className="flex h-screen bg-gray-100">
      <div className="bg-white shadow-lg overflow-hidden flex flex-col h-screen w-screen relative lg:flex-row">
        <div className="w-full h-1/2 bg-[#22243d] text-white -skew-y-[15deg] -translate-y-[40%] shadow-xl lg:w-1/2 lg:h-full lg:skew-y-[0] lg:translate-y-[0%] lg:-skew-x-[20deg] lg:-translate-x-[22%]">
          <div className="flex flex-col items-center justify-between gap-7 h-[60%] w-full absolute top-[25%] pt-20 skew-y-[15deg] lg:w-1/2 lg:skew-y-[0] lg:translate-x-[30%] lg:top-0">
            <div className="flex items-center gap-2 md:pt-12 lg:-translate-x-6">
              <svg
                className="h-8 w-8 text-purple-400 lg:skew-x-[20deg]"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
                <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"></path>
              </svg>
              <h2 className="text-2xl font-bold uppercase lg:skew-x-[20deg]">TimeLog</h2>
            </div>
          ...
          {/* clock icon from top */}
          <div className="absolute skew-y-[15deg] lg:skew-x-[20deg] lg:skew-y-0 w-[25vw] h-[25vw] md:w-[17vw] md:h-[17vw] bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 border border-purple-500 rounded-full flex items-center justify-center lg:w-[10vw] lg:h-[10vw] lg:translate-x-[20vw] lg:-translate-y-[20vw]">
        ...
        <div className="w-full h-4/6 flex flex-col items-center justify-center gap-5 absolute bottom-0 pt-10 lg:top-24 lg:translate-x-[20%]">
          <h2 className="text-3xl font-semibold md:text-4xl">
            {isSignUp ? "Sign up to join" : "Sign in to continue"}
          </h2>
          <form className="flex flex-col gap-3 md:w-96 lg:w-1/3">
            {isSignUp && (
              <div>
                <input
